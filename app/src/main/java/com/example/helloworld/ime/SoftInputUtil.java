        ...
        rootView.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (rootHeight - mutableHeight > rect.bottom) {
                    ...
                    //键盘高度
                    curSoftInputHeight = rootHeight - mutableHeight - rect.bottom;
                    if (softInputHeight != curSoftInputHeight) {
                        softInputHeightChanged = true;
                        softInputHeight = curSoftInputHeight;
                    } else {
                ...
                if (isSoftInputShowing != isSoftInputShow || (isSoftInputShow && softInputHeightChanged)) {
                    ...
                    listener.onChanged(isSoftInputShow, curSoftInputHeight, location[1] + anyView.getHeight() - rect.bottom);
