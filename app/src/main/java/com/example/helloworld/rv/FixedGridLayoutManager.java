...
public class FixedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d(TAG, "scrollVerticallyBy: before offset  topView.bottom: "+ getDecoratedBottom(topView));
        // after offset method executed, all children view's layout would change immediately
        offsetChildrenVertical(delta);
        Log.d(TAG, "scrollVerticallyBy: after offset  topView.bottom: "+ getDecoratedBottom(topView));
